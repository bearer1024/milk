    ...
    <div class="row-fluid">
        <div class="span3" id="sidebar">
            <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                <li class="active">
                    <a href="addMilkRegInfo.jsp"><i class="icon-chevron-right"></i>编辑奶粉资质管理页面</a>
                </li>
            </ul>
        </div>
        <!--/span-->
                            ...
                            <form class="form-horizontal" action="registCertificate/add" method="post">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" name="applicationNumber" type="text" value="${result.application_number}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">产品名称</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" name="productName" type="text" value="${result.product_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" name="powderLevel" type="number" value="${result.powder_level}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">申请人姓名</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" name="applicantName" type="text" value="${result.applicant_name}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">公布证书待领信息的时间</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" name="publishCertificateTime" type="datetime-local" value="${result.publish_certificate_time}">
                                        </div>
                                    </div>
